...
export default function TickMatch() {
  ...
  if (!isMember) {
    return (
      <div className="relative w-full min-h-screen text-white animate-fade-in pb-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-8 flex flex-col items-center">
          ...
          <div className="relative group w-full max-w-5xl mb-16">
            ...
            <div className="relative bg-[#0B1221] border border-slate-700/50 rounded-2xl shadow-2xl">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-8 flex flex-col items-center">
          ...
          <div className="flex gap-4 justify-center w-full">
            <button
              onClick={() => {
                setEnteredTool(true);
                sessionStorage.setItem("tickToolEntered", "true"); 
              }}

            ...
            {open && (
                <div style={popup}>
                    ...
                    {view === "day" && (<>
                        ...
                        <div style={footer}>
                            <span style={{ fontSize: 9, color: "#cbd5e1", letterSpacing: "0.1em", textTransform: "uppercase" }}>Trading Days</span>
                            <span style={{
                                fontSize: 11, fontWeight: 500, color: "#67e8f9",
                                background: "rgba(6,182,212,0.1)", padding: "1px 8px", borderRadius: 99,
